...
_原生异步架构 · TypeScript 全栈 · 插件热加载 · 与 TeleBox 一键互切_
...
🔀 **版本切换**  
`.switch go` 在 Next 与 TeleBox 之间直切，会话与插件配置一并迁移
...
<tr><td><strong>switch</strong></td><td><code>switch</code></td><td>Next ↔ TeleBox 版本切换（会话转换 + 配置迁移）</td></tr>
...
| 运行时 | Node.js | `24.x` |
| 语言 | TypeScript | `^5.9.2` |
| Telegram API | mtcute | `@mtcute/node ^0.31.0` |
