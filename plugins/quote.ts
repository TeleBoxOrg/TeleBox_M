...
const QUOTE_ASSETS_BASE_URL = "https://raw.githubusercontent.com/TeleBoxOrg/quote-api/master/assets";
...
async function prepareQuoteMedia(msg: MessageContext, args: QuoteArgs): Promise<{ mediaBuffer?: Buffer; mediaCanvas?: any; mediaType?: string; mediaMaxSize?: number; mediaCrop?: boolean; voice?: { waveform: number[] } }> {
  const kind = getMediaKind(msg);
